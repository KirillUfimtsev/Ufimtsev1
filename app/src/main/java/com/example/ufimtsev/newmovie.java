...
public class newmovie extends AppCompatActivity {
    ...
    EditText tvName;
    newmovie.MyTask mt;
    newmovie.MyTaskN mtn;
    newmovie.MyTaskTF mttf;
    ListView lvMain;
    //    String ID;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mt = new newmovie.MyTask();
        mt.execute();
    }
    public void onclick(View v) {
        mtn = new newmovie.MyTaskN();
    ...
    class MyTaskTF extends AsyncTask<String, Void, Void > {
        ...
        protected Void doInBackground(String... params) {
            ...
            try {
                myConnection.getOutputStream().write( ("ID=3&IDCinema=" + params[0]+"&IDMovie="+params[1]).getBytes());
            } catch (IOException e) {
                e.printStackTrace();
            };
...
//                        sb.append("\r\n : " +value);
        ...
        protected void onPostExecute(ArrayList<String[]> result) {
            super.onPostExecute(result);
            newmovie.ClAdapter clAdapter=new newmovie.ClAdapter(tvInfo.getContext(),result);
//          lvMain = (ListView) findViewById(R.id.lvMain);
