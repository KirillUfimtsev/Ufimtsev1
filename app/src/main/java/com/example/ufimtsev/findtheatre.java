...
public class findtheatre extends AppCompatActivity {

    TextView tvInfo;
    EditText tvName;
    findtheatre.MyTask mt;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_findtheatre);
        tvInfo = (TextView) findViewById(R.id.tvInfo);
        tvName = (EditText) findViewById(R.id.editTextTextPersonName);
    }

    public void onclick(View v) {
        mt = new findtheatre.MyTask();
    ...
    class MyTask extends AsyncTask<String, Void, ArrayList<String[]>> {
        ...
        protected void onPostExecute(ArrayList<String[]> result) {
            ...
            findtheatre.ClAdapter clAdapter=new
                    findtheatre.ClAdapter(tvInfo.getContext(),result);
